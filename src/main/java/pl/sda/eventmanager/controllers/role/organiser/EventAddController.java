package pl.sda.eventmanager.controllers.role.organiser;
...
public class EventAddController extends IndexListController {

    private final EventValidator eventValidator;
    private final EventService eventService;

    public EventAddController(EventValidator eventValidator, EventService eventService) {
        super(eventService);
